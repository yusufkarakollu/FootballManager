...
<script>
  function search() {
    ...
    // Seçilen seçeneğe göre uygun bilgileri alabilir ve gösterebilirsiniz.
    var sonucDiv = document.getElementById("sonuc");

    if (selectedOption === "secenek1") {
      sonucDiv.innerHTML = "Seçenek 1 için uygun bilgiler gösterilecek.";
    } else if (selectedOption === "secenek2") {
      sonucDiv.innerHTML = "Seçenek 2 için uygun bilgiler gösterilecek.";
    } else if (selectedOption === "secenek3") {
      sonucDiv.innerHTML = "Seçenek 3 için uygun bilgiler gösterilecek.";
    } else {
      sonucDiv.innerHTML = "Lütfen bir seçenek seçin.";
    }
  }
</script>